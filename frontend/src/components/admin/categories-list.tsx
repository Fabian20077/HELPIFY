...
export function CategoriesList({ initialCategories, initialDepartments }: CategoriesListProps) {
  type CategoryRow = CategoriesListProps['initialCategories'][number];
  const [categories, setCategories] = useState<CategoriesListProps['initialCategories']>(initialCategories);
